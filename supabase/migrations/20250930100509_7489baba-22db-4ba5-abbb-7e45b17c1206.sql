...
-- Fix build_student_registration_number to use correct format: SUBJECT-STATE-DISTRICT-SCHOOL-CLASS-STUDENT
-- Registration numbers will be generated in format: 5-33-038-XXXX-14-001 (for LKG) or 5-33-038-XXXX-15-001 (for UKG)
-- 5 = KidsPO subject code
-- 33 = Tamil Nadu state code
-- 038 = Virudhunagar district code
-- XXXX = School code (auto-generated, 4 digits padded)
...
BEGIN
  ...
  -- Get or create school code (4 digits)
  ...
  v_final_number := format(
    ...
    LPAD(v_school_code, 4, '0'),                -- School code (4 digits, e.g., 0143)
