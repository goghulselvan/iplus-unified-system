-- First update the generate_registration_number function to use predefined state codes only
...
-- Clean up the existing state codes and replace with official codes
-- First, remove all existing state codes
DELETE FROM public.state_codes;

-- Insert official Indian state codes according to government standards
