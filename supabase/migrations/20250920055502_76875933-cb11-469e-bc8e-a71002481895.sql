...
DROP FUNCTION IF EXISTS public.get_accountant_payment_data();

-- 3. Create a secure function that replaces the view functionality
...
-- 4. Create a secure view that uses the function (for backward compatibility)
