...
BEGIN
  ...
  -- Calculate effective rate (per_entry_rate - concession) for calculations
  -- NOTE: We don't SET this column anymore as it's a GENERATED ALWAYS column
  ...
  -- Calculate outstanding balance (can be negative if overpaid)
  ...
  -- Update school WITHOUT setting effective_rate_per_entry (it's a generated column)
