...
DROP POLICY IF EXISTS "Accountants can view schools with payment data" ON public.schools;

-- The existing "Accountants can view schools with payment data" policy already handles this
-- No need to add another policy as it would conflict with existing RLS policies
