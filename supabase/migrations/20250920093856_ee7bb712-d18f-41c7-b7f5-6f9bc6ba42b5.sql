-- Extend the name_list_status enum to include 'Uploaded' status
ALTER TYPE name_list_status ADD VALUE 'Uploaded';

-- Update the dashboard metrics function to include name list uploaded count
