...
-- Fix the ambiguous column reference issue by using table prefix in FILTER clauses
...
BEGIN
  ...
  SELECT
    ...
    COUNT(*) FILTER (WHERE a.s_brochure_delivery_status = 'Both Physical and Digital')::bigint AS brochure_both_physical_digital,
