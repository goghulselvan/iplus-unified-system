-- Fix the ambiguous subject_code reference by using explicit CTE
...
BEGIN
  ...
  -- Get subject code using explicit CTE to avoid any ambiguity
  ...
  SELECT code INTO v_subject_code FROM subject_data;
