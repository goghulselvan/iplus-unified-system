-- Drop and recreate function to add registration_in_progress metric
DROP FUNCTION public.get_dashboard_metrics_by_project(uuid);

CREATE OR REPLACE FUNCTION public.get_dashboard_metrics_by_project(target_project_id uuid DEFAULT NULL::uuid)
RETURNS TABLE(
