-- Drop all existing versions of the generate_registration_number function
...
DROP FUNCTION IF EXISTS public.generate_registration_number(p_school_id uuid, p_project_id uuid, p_student_class text);
DROP FUNCTION IF EXISTS public.generate_registration_number(p_school_id uuid, p_project_id uuid, p_student_class text, p_subject_id uuid);
